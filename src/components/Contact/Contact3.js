        ...
        <div className='grid grid-cols-2'>
          ...
          <form onSubmit={handleSubmit}>
            <div className='flex flex-col px-[12px]'>
              <div className='flex'>
                <input required placeholder="Họ tên học viên" type="text" className='bg-[#f4f5f7] w-full p-[16px] mx-[12px] mb-[36px] rounded-[10px] border-2 border-solid border-[#f4f5f7]' name="fullname" value={state.fullname} onChange={(event) => handleOnChangeInput(event, 'fullname')}/>
                <input required placeholder="Số điện thoại" type="text" className='bg-[#f4f5f7] w-full p-[16px] mx-[12px] mb-[36px] rounded-[10px] border-2 border-solid border-[#f4f5f7]' name="phonenumber" value={state.phonenumber} onChange={(event) => handleOnChangeInput(event, 'phonenumber')}/>
              </div>
              <div className='flex'>
                <select required className='bg-[#f4f5f7] w-full p-[16px] mx-[12px] mb-[36px] rounded-[10px] border-2 border-solid border-[#f4f5f7] text-[#52525C]' name="course" value={state.course} onChange={(event) => handleOnChangeInput(event, 'course')}>
                ...
                <select required className='bg-[#f4f5f7] w-full p-[16px] mx-[12px] mb-[36px] rounded-[10px] border-2 border-solid border-[#f4f5f7] text-[#52525C]' name="local" value={state.local} onChange={(event) => handleOnChangeInput(event, 'local')}>
