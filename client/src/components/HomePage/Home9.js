          ...
          <div className='flex flex-col p-[10px]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 w-full'>
              <div className='p-[10px]'>
                <div className='bg-white shadow-home9 rounded-[4px] pt-[24px] pr-[32px] pb-[40px] pl-[35px] w-full h-full'>
        ...
        <div className='relative z-[2]'>
          <form className='w-[85%] px-[40px] py-[48px] bg-white shadow-home2 rounded-[10px] mx-auto md:m-[50px]' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col px-[12px]'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className='px-[12px]'>
                  <select className='w-full p-[16px] mb-[36px] rounded-[10px] border-2 border-solid border-[#0B163F1F] text-[#52525C]' name="course" value={state.course} onChange={(event) => handleOnChangeInput(event, 'course')}>
                ...
                <div className='px-[12px]'>
                  <select className='w-full p-[16px] mb-[36px] rounded-[10px] border-2 border-solid border-[#0B163F1F] text-[#52525C]' name="local" value={state.local} onChange={(event) => handleOnChangeInput(event, 'local')}>
