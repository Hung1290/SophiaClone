    ...
    <div className='bg-[#fafafa]'>
      <div className='pt-[60px] w-4/5 mx-auto'>
        <div className='p-[15px]'>
          <h2 className='flex justify-center text-[40px] text-[#cf0f0f] uppercase mb-[10px] text-center font-bold'>GIÚP CON KHƠI MỞ TIỀM NĂNG TRONG MÌNH</h2>
          <p className='text-center mb-[16px]'>Cung cấp các kiến thức bổ ích cho bé và cung cấp những các phương pháp giảng dạy cho phụ huynh giúp phụ huynh có thể kèm cặp các bé tốt hơn.</p>
        </div>
        <div className='py-[30px]'>
          <div className='grid grid-cols-1 lg:grid-cols-2 w-full'>
            ...
            <div className='p-[10px]'>
              <img src='https://sec-vietnam.edu.vn/wp-content/uploads/2022/11/SOPHIA-ENGLISH-CENTER-14-min.png' className='rounded-[20px]'/>
            </div>
          </div>
        </div>
      </div>
