      ...
      <div className='w-4/5 mx-auto py-[120px]'>
        <div className='lg:flex'>
          <div className='flex-1 mx-[15px]'>
            <div className='md:flex border-2 border-solid border-[#dee2e6] rounded-[15px] overflow-hidden'>
              <div className='flex flex-col w-full'>
                <div className='px-[30px] pt-[60px] pb-[50px] border-b-2 md:border-r-2 border-solid border-[#dee2e6] bg-[#f8f9fa]'>
                ...
                <div className='px-[30px] pt-[60px] pb-[50px] border-b-2 md:border-r-2 border-solid border-[#dee2e6]'>
                ...
                <div className='px-[30px] pt-[60px] pb-[50px] border-b-2 md:border-b-0 md:border-r-2 border-solid border-[#dee2e6] bg-[#f8f9fa]'>
          ...
          <div className='flex-1 pr-[15px] pl-[17px]'>
            ...
            <div className='md:flex'>
              <img alt='' src='/images/SOPHIA-ENGLISH-CENTER-9-min.png' className='w-full md:w-[160px] p-[10px]'/>
              <img alt='' src='/images/SOPHIA-ENGLISH-CENTER-8-min.png' className='w-full md:w-[160px] p-[10px]'/>
            </div>
          </div>
        </div>
      </div>
